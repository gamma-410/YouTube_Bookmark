<template>
  <div class="new"><br>
    <h3>YouTube Bookmarkへようこそ</h3>
    YouTube の楽しい動画をみんなで共有しましょう！<br><br>
    <h3>利用規約</h3>
      この利用規約（以下，「本規約」といいます。）は，YouTube Bookmark（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。<br>
      <br>
      ...
      <h4>第7条（退会）</h4>
      ユーザーは，一度登録した方は他基本的に退会できないこととします。<br>
      万が一退会する必要がある場合は運営側へ連絡することで退会できることとします。<br><br>
      ...
      以上<br><br>
    <router-link to="/user"><b-button block>利用を開始する</b-button></router-link><br><br>
  </div>    
</template>
